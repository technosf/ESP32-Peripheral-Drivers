...
//            }
    ...
    m_rom_codes.swap( valid_registration_codes );    // Device registration codes and their bus
...
//    || !m_rom_codes.emplace( registration_code, bus ).second )    // Already known
//        return nullptr;
//
//    /*
